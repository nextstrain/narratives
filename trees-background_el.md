...
<p>
<img width="500px" alt="σκίτσο το οποίο παρουσιάζει πως σχετίζεται το δέντρο μετάδοσης με το φυλογενετικό δέντρο" src="https://raw.githubusercontent.com/nextstrain/narratives/master/figures/infection_tree_combined.png"/>
</p>
<p>
...
<div width="50%" margin="auto">
<p>
<img width="700px" alt="Παράδειγμα φυλογένεσης όπου όλα ή μόνο ένα υποσύνολο κρουσμάτων περιλαμβάνονται στην τελική φυλογένεση" src="https://raw.githubusercontent.com/nextstrain/narratives/master/figures/toy_alignment_tree.png"/>
</p>
<p>
...
<div width="50%" margin="auto">
<p>
<img width="700px" alt="Εικόνα που δείχνει πώς η δειγματοληψία επιδρά στην ερμηνεία της εξάπλωσης του ιού" src="https://raw.githubusercontent.com/nextstrain/narratives/master/figures/introductions.png"/>
</p>
<p>
