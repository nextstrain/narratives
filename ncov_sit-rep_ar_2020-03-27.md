...
<br><br>
اذا لم تكن على دراية باشجار التصنيف الجيني، فنحن نشجعك على فحص تقرير  ['كيف تقرأ التصنيف الجيني' ](https://nextstrain.org/narratives/trees-background/ar)  لتعود بعد ان تكون جاهزا
<!-- This is right-side text -->
```auspiceMainDisplayMarkdown

## مصار Nextstrain (السلالة التالية)

[كيف تقرأ التصنيف الجيني](https://nextstrain.org/narratives/trees-background/ar).  
