...
abstract: >-
  On 5 May 2026 the WHO was [notified](https://www.afro.who.int/publications/ebola-bundibugyo-virus-disease-outbreak-democratic-republic-congo-uganda-weekly) of a disease of unknown origin with high mortality in the Mongbwalu health zone in Ituri DRC.
  ...
  Researchers at INRB and their partners have rapidly sequenced isolates throughout the outbreak. 
  Here, we summarize epidemiological insights gained from this genomic surveillance. 

---

# [Epidemiological inference from genomes](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01)

RNA viruses, such as BDBV, are characterized by error-prone replication and high mutation rates.
...
# [Over 700 cases have been sequenced to date](https://nextstrain.org/ebola/bdbv-drc-uganda-2026?branches=hide&c=country&d=tree&l=scatter&p=full)

Currently, BDBV genomes have been generated from over 700 cases.
Each circle represents a sequenced sample plotted by country (y-axis) and date of sampling (x-axis)


# [Constructing a phylogenetic tree](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?c=country&d=tree&m=div&p=full)

We can reconstruct the phylogenetic tree that clusters and connects these samples based on the mutations present in each sequence. 
...
# [The current outbreak stems from a novel spill-over event](https://nextstrain.org/ebola/bdbv@2026-09-01?c=outbreak&d=tree&focus=selected&p=full)
...
# [Evidence of rapid transmission](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?&d=tree&m=div&p=full)

Zooming into the outbreak clade, we can make a few high-level observations.

Interestingly, the tree is made of many clades that look like combs.
Note the long vertical lines at the base of many branches. 
...
# [Mutations define each cluster](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?c=gt-nuc_10319&d=tree&m=div&p=full) 

Genomes are clustered in the tree by shared mutations.
We have colored branches in the tree by the nucleotide at position 10319.
You can hover on any branch to see which mutations likely occurred on that branch. 


So far, there is nothing to suggest mutations found at high frequencies are adaptive, or that positive selection is driving the epidemic.
...
It does not change any viral proteins, and it likely reached a high frequency due to chance epidemiological events.


<!-- 
# [2026 outbreak](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?d=tree&m=div&p=full)
...
# [Estimating the evolutionary rate](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?d=tree&l=clock&m=div&p=full)
...
Preliminary analyses suggests the virus has been accumulating mutations at a rate of 6 or 7 × 10<sup>-4</sup> substitutions/site/year largely consistent with previous estimates from related Ebola species.
...
# [When did the outbreak begin?](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?d=tree&p=full)

We can use the evolutionary rate to estimate dates for key events such as when the outbreak began.
Our current estimate is that the outbreak began in early 2026, near the end of January, several weeks before the first cases were detected.
...
Slight differences between the root date and the clock rate are expected given the different methodologies and datasets used.


# [Mongbwalu, Rwampara, and Bunia formed the initial epicenter of the outbreak.](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?c=location&d=tree&f_location=Bunia,Rwampara,Mongbwalu&p=full)

<!-- Bunia 210 Rwampara  155 Monbualu 55-->

Samples have been sequenced from 30 health zones in DRC; however, three health zones (Bunia , Rwampara, Mongbwalu) contribute 2/3rds of the genomes.
...
But we can learn something from general trends. 

Here we have combined Mongbwalu, Bunia, and Rwampara into a single epicenter.
The geographic reconstruction supports the conclusions above and highlights how exported cased from the epicenter sparked transmission chains in the surrounding region. 
This pattern is consistent with early reports that the outbreak may have begun in Mongbwalu and the large number of early cases in Mongbwalu, Bunia, and Rwampara.
...
# [Evidence of local transmission in Nizi](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?d=tree&f_location=Nizi&focus=selected&p=full)

Early in the epidemic, Nizi was another source of many cases.
The clustering of sequences from Nizi is consistent with local transmission and the high number of cases observed in this region.

# [Shifting centers of transmission](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?d=tree&f_location=Nia%20Nia&p=full)

[Recently](https://iris.who.int/server/api/core/bitstreams/2dfa5168-2ff5-474f-829b-33b715616b1f/content), cases have begun to decrease slightly in Mangwalu, Rwampara, Bunia, and Nizi.
At the same time transmission is increasing in other regions, such as Nia Nia.
Here we can a cluster of cases in Nia Nia (bottom).
The timing of this clade suggests there was local transmission in the region in early June. 

# [Limited local transmission in Uganda](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?c=country&d=tree&f_country=Uganda&p=full)
...
# [Other resources](https://nextstrain.org/ebola/bdbv-drc-uganda-2026@2026-09-01?c=location_reconstructed&d=tree,map&p=grid&r=location_epicenter)
